...
- **Uppercase is earned and wide**: When uppercase appears, it's always paired with generous letter-spacing (0.45px-2.52px), transforming dense words into overline labels. This treatment is never applied to headings.
