...
### Surface & Overlay
- **Glass Dark** (`rgba(41, 41, 41, 0.84)`): Translucent overlay panels
...
- **Default**: No shadows — Supabase uses almost no shadows in its dark theme. Depth is created through border contrast and surface color differences rather than box-shadows.
